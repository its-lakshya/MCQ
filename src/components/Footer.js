...
const Footer = () => {
  return (
    <div
      className="w-full h-[25rem] bg-[#1D4645] mt-10 px-48 flex flex-col items-center justify-center font-extralight gap-y-12
    ...
    >
      <div className="flex justify-between items-center w-2/3 text-white max-lg:w-full">
        ...
        <div className="flex items-center justify-center gap-x-4 text-[#1D4645] max-xxs:flex-col max-xxs:gap-y-2">
          <span className="bg-[#E8C5B0] w-12 h-12 max-md:w-8 max-md:h-8 rounded-full flex items-center justify-center">
            <FaFacebookF />
          </span>
          <span className="bg-[#E8C5B0] w-12 h-12 max-md:w-8 max-md:h-8 rounded-full flex items-center justify-center">
            <FaTwitter />
