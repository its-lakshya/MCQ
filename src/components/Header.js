...
const Header = () => {
    ...
    return(
        <div className='w-full h-20 font-bold flex justify-center bg-white bg-opacity-95 shadow-lg '>
            <div className='w-full px-48 flex justify-between items-center max-lg:w-full max-lg:px-6'>
            <span className="font-bold text-3xl text-[#1D4645] -mt-2 max-sm:text-2xl">MCQ</span>
            <ul className='flex justify-center gap-x-10 font-light   max-sm:hidden'>
            ...
            <button className=" rounded-md flex justify-center items-center w-36 font-bold text-lg text-[#1D4645]">
